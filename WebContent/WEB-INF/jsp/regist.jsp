...
<title>会员注册</title>
<script src="${pageContext.request.contextPath}/js/pccs.js"  type="text/javascript"></script>
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<s:form id="registerForm"  action="SSHproject/user_regist.action" method="post" novalidate="novalidate" onsubmit="return checkForm();" theme="simple">
						...
						<table>
							<tbody><tr>
								...
								<td>
									<s:textfield type="text" id="username" name="username" class="text" maxlength="20" onblur="checkUsername()"/>
									<span id="span1"></span>
								</td>
							</tr>
							<tr>
								...
								<td>
									<s:textfield type="password" id="password" name="password" class="text" maxlength="20" autocomplete="off"></s:textfield>
							...
							<tr>
								...
								<td>
									<s:textfield id="repassword" type="password" name="repassword" class="text" maxlength="20" autocomplete="off"></s:textfield>
								</td>
							</tr>
							<tr>
								<th>
								...
								<td>
									<s:textfield type="text" id="email" name="email" class="text" maxlength="200"></s:textfield>
									...
									<tr>
										...
										<td>
												<s:textfield type="text" name="name" class="text" maxlength="200"></s:textfield>
									...
									<tr>
										...
										<td>
												<s:textfield type="text" name="phone" class="text"></s:textfield>
										</td>
									</tr>
									<tr>
										<th>
									...
									<tr>
										...
										<td>
												<s:textfield type="text" name="addr" class="text" maxlength="200"></s:textfield>
...
/* 	document.getElementById("checkcode").onblur = function(){
	  	...
	  	var method = "post";
	  	var url = "${pageContext.request.contextPath}/user_checkCheckcode?time"+new Date().getTime();
	  	ajax.open(method,url);
	  	ajax.setRequestHeader("content-type","application/x-www-form-urlencoded");
	  	var context = "checkcode="+checkcode;
	  	ajax.send(context);
	  	//========================================================
