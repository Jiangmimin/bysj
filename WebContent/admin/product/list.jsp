...
<script language="javascript"> 
    	...
    	if (confirm("是否删除该商品？")) { 
					...
					// 3.打开连接
					xhr.open("GET","${pageContext.request.contextPath}/adminProduct_delete.action?pid="+u_id,true);
					// 4.发送
					xhr.send(null);
					location.reload();
				}else{
	...
	<body>
		<br>
			<form action="${pageContext.request.contextPath}/adminProduct_findByKey.action" method="post">
								...
								<s:iterator var="product" value="pageBean.list" status="status">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												...
												<input type="button" value="删除" id="but<s:property value="#product.pid"/>" 
												onclick="userDelete(<s:property value="#product.pid"/>)" style="CURSOR: hand"/>
											</td>
										</tr>
									</s:iterator>	
							</table>
