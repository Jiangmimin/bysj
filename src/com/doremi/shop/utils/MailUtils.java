...
public class MailUtils {
	...
	public void sendMail(String To,String Code) throws Exception{
		...
		props.load(MailUtils.class.getClassLoader().getResourceAsStream("email_template.properties"));
	...
	/*public static void main(String[] args) {
		...
		try {
			mail.sendMail("1064121718@qq.com", "11");
		} catch (Exception e) {
